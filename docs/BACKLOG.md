...
- **Make a stub real** (needs the reference to take a dependency): real model engines behind the auto-router, real voice (whisper/Piper), real browser, real sandbox enforcement (namespaces/seccomp/landlock + WASM-component).
