...
## Instance 1 — worker · Disposition routing (intake → action)  (worktree `~/decima-work-disp`)

`git worktree add ~/decima-work-disp work/disp1-disposition`.
...
```text
You are a worker disposition instance for Decima, in a dedicated worktree. Read docs/BACKLOG.md
...
Task DISP1 — branch work/disp1-disposition — GTD for the machine age:
...
Bootstrap: scripts/kickoff.sh ~/decima-work-disp work/disp1-disposition
...
## Instance 2 — worker · Morta-gated payments rail  (worktree `~/decima-work-pay`)

`git worktree add ~/decima-work-pay work/pay1-payments`.
...
```text
You are a worker payments instance for Decima, in a dedicated worktree. Read docs/BACKLOG.md (brief
...
Task PAY1 — branch work/pay1-payments — financial transactions as the canonical irreversible effect:
...
Bootstrap: scripts/kickoff.sh ~/decima-work-pay work/pay1-payments
...
## Instance 3 — kernel · Incremental fold-from-base  (clone `~/decima-work`)
...
```text
You are the worker kernel/perf instance for Decima, in ~/decima-work. Read docs/BACKLOG.md (brief
...
Task IFB1 — branch work/ifb1-incremental-fold — the snapshot perf win:
...
Bootstrap: scripts/kickoff.sh ~/decima-work work/ifb1-incremental-fold
