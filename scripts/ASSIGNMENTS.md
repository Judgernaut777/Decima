...
## Instance 1 — worker · REDACT (core, the §11 closer)  (clone: `~/decima-work`)
...
```text
You are the worker retraction instance for Decima, in ~/decima-work. Read docs/BACKLOG.md
(brief R1), specs/FOLD_AND_LIFECYCLE.md §10, specs/WEFT_PROTOCOL.md §5, and
heartbeat/checks/README.md first.

Task R1 — branch work/r1-redact — close the last partial §11 invariant:
...
Bootstrap: scripts/kickoff.sh ~/decima-work work/r1-redact
...
## Instance 2 — worker · sync transport  (worktree, e.g. `~/decima-work-sync`)

`git worktree add ~/decima-work-sync work/sy2-sync-transport`.
...
```text
You are a worker sync-transport instance for Decima, in a dedicated worktree (NOT the main
~/decima-work tree). Read docs/BACKLOG.md (brief SY2), specs/SYNC.md, and
heartbeat/checks/README.md first.

Task SY2 — branch work/sy2-sync-transport — realize SYNC.md between TWO real Weft instances
...
Bootstrap: scripts/kickoff.sh ~/decima-work-sync work/sy2-sync-transport
...
## Instance 3 — worker · memory governance  (worktree, e.g. `~/decima-work-gov`)

`git worktree add ~/decima-work-gov work/b4-governance`.
...
```text
You are a worker memory-governance instance for Decima, in a dedicated worktree. Read
docs/BACKLOG.md (brief B4), specs/MEMORY_ARCHITECTURE.md, and heartbeat/checks/README.md first.

Task B4 — branch work/b4-governance — give memory governance teeth:
...
Bootstrap: scripts/kickoff.sh ~/decima-work-gov work/b4-governance
