...
## Instance 1 — worker · Wager/Verdict loop (the learning loop)  (worktree `~/decima-work-wv`)

`git worktree add ~/decima-work-wv work/wv1-wager`.
...
```text
You are a worker wager/verdict instance for Decima, in a dedicated worktree. Read docs/BACKLOG.md
(brief WV1), specs/CAPABILITY_MAP.md D4, specs/MORTA_CAPABILITIES.md, and heartbeat/checks/README.md.

Task WV1 — branch work/wv1-wager — the scientific method as Cells:
...
Bootstrap: scripts/kickoff.sh ~/decima-work-wv work/wv1-wager
...
## Instance 2 — worker · Orientation lens ("the Big O")  (worktree `~/decima-work-or`)

`git worktree add ~/decima-work-or work/or1-orientation`.
...
```text
You are a worker orientation instance for Decima, in a dedicated worktree. Read docs/BACKLOG.md
(brief OR1), specs/CAPABILITY_MAP.md D4, specs/MEMORY_ARCHITECTURE.md (B4 governance), and
heartbeat/checks/README.md first.

Task OR1 — branch work/or1-orientation — make Orientation explicit:
...
Bootstrap: scripts/kickoff.sh ~/decima-work-or work/or1-orientation
...
## Instance 3 — worker · Auto-router  (worktree `~/decima-work-ar`)

`git worktree add ~/decima-work-ar work/ar1-autorouter`.
...
```text
You are a worker auto-router instance for Decima, in a dedicated worktree. Read docs/BACKLOG.md
(brief AR1), specs/CAPABILITY_MAP.md D3.1, heartbeat/decima/router.py (Router/route/select), and
heartbeat/checks/README.md first.

Task AR1 — branch work/ar1-autorouter — automatic, intelligent model switching:
...
Bootstrap: scripts/kickoff.sh ~/decima-work-ar work/ar1-autorouter
