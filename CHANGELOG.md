...
routing path. Full gate on the candidate: **542 passed / 25 skipped**, **13 Playwright specs across
9 files**, adversarial **44**; `heartbeat/`, `decima/kernel/`, and `protocol/` remain byte-frozen.
