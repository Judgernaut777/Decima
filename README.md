...
agents, isolated coding workspace), and ops (backup/restore/doctor). **580 tests green
(580 passed / 25 skipped)** plus **13 Playwright specs across 9 files** driving the real
