...
agents, isolated coding workspace), and ops (backup/restore/doctor). **574 tests green
(574 passed / 25 skipped)** plus **13 Playwright specs across 9 files** driving the real
