...
Decima is built by a human and more than one coding agent (Worker A, Worker B)
...
|---|---|---|
| Worker A | `~/decima-work` | `git@github-decima-work:Judgernaut777/Decima.git` |
| Worker B  | `~/decima-review`  | `git@github-decima-review:Judgernaut777/Decima.git` |
...
```bash
ssh -T github-decima-work   # → "Hi Judgernaut777/Decima!"
```
